#  Ai Security Log Analysis System

**Structured Generation Security System Evaluating Data**


## About
This  is a proof-of-concept that iterates through arbitrary logs in chunks, and for each chunk it will generate a summary of the logs and a list of potential security issues. 

Ailog heavily applies structured generation techniques to review logs, using [Outlines].
...
- Produces strongly-typed JSON output using [Outlines].
...
```bash
git clone https://github.com/akshat1618/Ailog_Analyzer.git
...
Ailog provides two ways to handle results:
